...
import com.example.drive_safe.model.Marker;
...
public class MarkerForm extends MainActivity implements OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.imageView = (ImageView) findViewById(R.id.g_marker);
        ...
        TextView currentLocation = (TextView) findViewById(R.id.your_location);
        ...
        ImageView imageView = (ImageView) findViewById(R.id.g_marker);
